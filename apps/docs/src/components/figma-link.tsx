...
const FigmaLink = () => {
  return (
    ...
    >
      <div className="bg-ui-bg-subtle shadow-elevation-card-rest hover:shadow-elevation-card-hover my-4 flex cursor-pointer items-center rounded-lg p-4 transition-all">
