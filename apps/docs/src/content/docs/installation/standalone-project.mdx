...
The components are styled using Tailwind CSS, and in order to use them, you need to install Tailwind CSS in your project as well.
...
<br/>
All of the classes used for Medusa UI is shipped in a Tailwind CSS. You install it with the following command:
...
const uiPath = path.resolve(require.resolve("@medusajs/ui"), "../..", "**/*.{js,jsx,ts,tsx}")
