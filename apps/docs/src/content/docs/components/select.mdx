...
By hooking into the <Code>onSearch</Code> prop, you can read the input's value and perform actions such as searching
...
You can attach a handler to the root's <Code>onScrollToBottom</Code> listener and perform actions such as pagination.
