export const effects = {
  "dark": {
    ...
    "--buttons-inverted-focus": "0px 1.5px 0px 0px rgba(255, 255, 255, 0.1) inset, 0px 0.25px 0px 0px rgba(0, 0, 0, 0.6), 0px 0.5px 0px 0px rgba(0, 0, 0, 0.6), 0px 0px 0px 1px rgba(27, 27, 31, 1), 0px 0px 0px 3px rgba(96, 165, 250, 0.8)",
    "--borders-focus": "0px 0px 0px 1px rgba(23, 23, 23, 1), 0px 0px 0px 3px rgba(96, 165, 250, 0.8)",
    "--buttons-danger": "0px 0.25px 0px 0px rgba(0, 0, 0, 0.6), 0px 0.5px 0px 0px rgba(0, 0, 0, 0.6)",
    ...
    "--buttons-danger-focus": "0px 0.25px 0px 0px rgba(0, 0, 0, 0.6), 0px 0.5px 0px 0px rgba(0, 0, 0, 0.6), 0px 0px 0px 1px rgba(27, 27, 31, 1), 0px 0px 0px 3px rgba(96, 165, 250, 0.8)",
    "--borders-base": "0px 0px 0px 1px rgba(46, 48, 53, 1)",
    "--borders-interactive-with-active": "0px 0px 0px 3px rgba(59, 130, 246, 0.25)",
    ...
    "--buttons-inverted": "0px 1.5px 0px 0px rgba(255, 255, 255, 0.1) inset, 0px 0.25px 0px 0px rgba(0, 0, 0, 0.6), 0px 0.5px 0px 0px rgba(0, 0, 0, 0.6)",
