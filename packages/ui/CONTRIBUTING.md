...
As this package contains components for the Medusa UI designs system, we do not accept PR's for new components. If you have a suggestion for a new component, please open an issue instead and label it with `feature request`.
